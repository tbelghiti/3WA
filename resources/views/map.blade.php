...
<body>
    <div id=" map-search">
        <input id="search-txt" type="text" value="Disneyland, 1313 S Harbor Blvd, Anaheim, CA 92802, USA"
            maxlength="100">
    ...
    <form class="mt-3" action="{{route('weatherLL')}}" method="POST">
        @csrf
    ...
    function loadmap() {
        ...
        google.maps.event.addListener(map, "idle", function() {
            ...
            document.getElementById("map-output").innerHTML = "Latitude: " + map.getCenter().lat()
                .toFixed(
                    6) +
                "<br>Longitude: " + map.getCenter().lng().toFixed(6) +
                "<a href='https://www.google.com/maps?q=" + encodeURIComponent(map.getCenter()
                    .toUrlValue()) +
                "' target='_blank'>Go to maps.google.com</a>";
            //////////////////////////////////////////////////////////
        ...
        if (navigator.geolocation) {
            google.maps.event.addDomListener(document.getElementById("detect-btn"), "click", function() {
                navigator.geolocation.getCurrentPosition(function(position) {
                    map.setCenter(new google.maps.LatLng(position.coords.latitude, position
                        .coords
                        .longitude));
                }, function() {
    ...
    <script
        src="//maps.googleapis.com/maps/api/js?v=3&amp;sensor=false&amp;key=AIzaSyCJO83xzvE1FS7Otuu2Suujgy4aX5f1fqQ&amp;callback=loadmap"
        defer>
    </script>
</body>
